...
__________________________
### різниця const fs = require('fs').

Спочатку сам модуль був написаний з використанням call-back функцій і викликався через const `fs = request("fs")`;
...
Давайте поговоримо про базове JS
